    ...
    int       nCmdShow)
{
    ...
    return Game01Player::createAndRun();
}

int Game01Player::createAndRun(void)
{
    Game01Player *host = Game01Player::sharedInstance();
    int ret = host->run();
    Game01Player::purgeSharedInstance();
    return ret;
}

Game01Player *Game01Player::s_sharedInstance = NULL;

Game01Player *Game01Player::sharedInstance(void)
{
    if (!s_sharedInstance)
    {
        s_sharedInstance = new Game01Player();
    }
    return s_sharedInstance;
}

void Game01Player::purgeSharedInstance(void)
{
    if (s_sharedInstance)
    {
...
Game01Player::Game01Player(void)
: m_app(NULL)
, m_hwnd(NULL)
, m_exit(TRUE)
...
int Game01Player::run(void)
{
    ...
    do
    {
        ...
        SetWindowTextA(m_hwnd, "game01-player");
...
void Game01Player::loadProjectConfig(void)
{
    vector<string> args;
...
void Game01Player::createViewMenu(void)
{
...
void Game01Player::updateMenu(void)
{
    HMENU menu = GetMenu(m_hwnd);
    HMENU viewMenu = GetSubMenu(menu, 1);
...
void Game01Player::updateWindowTitle(void)
{
}

void Game01Player::relaunch(void)
{
...
void Game01Player::writeDebugLog(const char *log)
{
...
// menu callback
void Game01Player::onFileOpenProject(void)
{
...
void Game01Player::onFileCreateProjectShortcut(void)
{
    ...
    if (SUCCEEDED(hres))
    {
        ...
        psl->SetDescription(L"Game01Player");
...
void Game01Player::onFileProjectConfig(void)
{
...
void Game01Player::onFileRelaunch(void)
{
    relaunch();
}

void Game01Player::onFileExit(void)
{
    DestroyWindow(m_hwnd);
}

void Game01Player::onViewChangeFrameSize(int viewMenuID)
{
...
void Game01Player::onViewChangeOrientation(int viewMenuID)
{
    bool isLandscape = m_project.isLandscapeFrame();
...
void Game01Player::onViewChangeZoom(int scaleMode)
{
    float scale = 1.0f;
...
void Game01Player::onHelpAbout(void)
{
    DialogBox(GetModuleHandle(NULL), MAKEINTRESOURCE(IDD_ABOUTBOX), m_hwnd, AboutDialogCallback);
}

// windows callback
LRESULT Game01Player::WindowProc(UINT message, WPARAM wParam, LPARAM lParam, BOOL* pProcessed)
{
    int wmId, wmEvent;
    Game01Player *host = Game01Player::sharedInstance();
...
INT_PTR CALLBACK Game01Player::AboutDialogCallback(HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam)
{
